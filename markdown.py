...
SCOPES = [
    ...
    "https://www.googleapis.com/auth/drive.readonly",  # 구글 문서 읽기용
]
...
def get_gdoc_content(service, file_id):
    ...
    마크다운처럼 보이도록 기본 변환 적용.
    """

    try:

        # text/plain으로 export (마크다운 export는 Google 측 미지원)
